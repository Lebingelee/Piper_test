...
CONFIG_PATH="${CONFIG_PATH:-train_setting/debug/ITQC/finetune_config.yaml}"
CKPT_PATH="${CKPT_PATH:-train_setting/debug/ITQC/critic_only_ckpt.pth}"
REPLAY_H5_PATH="${REPLAY_H5_PATH:-data/Rollout_cpiql/group_1/traj_10_0514_2356.h5}"
SAVE_DIR="${SAVE_DIR:-eval/itqc_anchor1:1}"
TRAJ_IDX="${TRAJ_IDX:-0}"
DEVICE="${DEVICE:-}"
